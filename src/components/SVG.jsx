...
export default function SVG({ bubble, background, tea, border, isSmile, size, isTube }) {
  return (
    <svg
    ...
    >
      <g id="bubbletea">
        ...
        <g id="background" fill={background}>
          <path d="M19.5,50c1.4-7.1,4.4-13.9,8.8-19.7c2.9-3.8,6.3-7.2,10.2-10.1c8.2-5.9,17.9-9.1,28.1-9.1c10.3,0,20,3.2,28.2,9.2c3.9,2.8,7.3,6.2,10.2,10.1c4.4,5.9,7.3,12.6,8.7,19.7L19.5,50z"></path>
        ...
        <g id="tea" fill={tea}>
          ...
          ></path>
          <path d="M28.9,119.1l3.6,34.5c1.4,13,12.3,22.9,25.3,22.9l17.1,0c13,0,24-9.8,25.4-22.9l6.2-57.2C79.6,85,61.3,112.6,28.9,119.1z"></path>
        </g>
        <g id="border" stroke={border}>
          <path
            fill="none"
            strokeWidth="2.1561"
            strokeLinecap="round"
